    ...
    function ($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider
        ...
        .state("city.status", {
          ...
          templateUrl: 'views/issues/issue-status.html',
        ...
        .state("city.status.item", {
          url: '/:code',
          templateUrl: 'views/issues/issue-status-result.html',
        ...
        .state("city.report", {
          ...
          templateUrl: 'views/issues/issue-create-categories.html',
          resolve: {
        ...
        .state("city.report.map", {
          url: '/:type',
          templateUrl: 'views/issues/issue-create-map.html',         
        ...
        .state("city.report.map.details", {
          url: '/details?lat&lng',
          templateUrl: 'views/issues/issue-create-details.html',
          resolve: {
